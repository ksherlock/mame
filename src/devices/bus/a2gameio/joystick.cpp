...
#ifdef AMPLE
	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1)   PORT_NAME("P1 Button 1") PORT_PLAYER(1)            PORT_CODE(JOYCODE_BUTTON1)
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2)   PORT_NAME("P1 Button 2") PORT_PLAYER(1)            PORT_CODE(JOYCODE_BUTTON2)
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1)   PORT_NAME("P2 Button 1") PORT_PLAYER(2)            PORT_CODE(JOYCODE_BUTTON1)
	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON2)   PORT_NAME("P2 Button 2") PORT_PLAYER(2)            PORT_CODE(JOYCODE_BUTTON2)
#else
