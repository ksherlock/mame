...
#ifdef AMPLE
// just use a standard keyboard layout. * indicates a change
// n.b. - control-shift-2 generates 0, no other control-number generates a control char
...
/*    norm shft ctrl both */
	...
	{ 0x50,0x50,0x10,0x10, 0x70,0x50 },    // p P     13*
	...
	{ 0x4e,0x4e,0x1e,0x1e, 0x6e,0x4e },    // n N     23*
...
static INPUT_PORTS_START( apple2_nkbd )
	...
	PORT_BIT(0x100, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_MINUS)  PORT_CHAR('-') PORT_CHAR('_') //*
	...
	PORT_BIT(0x200, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_P)  PORT_CHAR('P', 'p') PORT_CHAR() PORT_CHAR(0x10) //*
	...
	PORT_BIT(0x004, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_G)  PORT_CHAR('G', 'g') PORT_CHAR() PORT_CHAR(0x07) //*
	...
	PORT_BIT(0x020, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_N)  PORT_CHAR('N', 'n') PORT_CHAR() PORT_CHAR(0x0e) //*
	...
	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("Ctrl")         PORT_CODE(KEYCODE_LCONTROL) PORT_CODE(KEYCODE_RCONTROL) PORT_CHAR(UCHAR_SHIFT_2) //*
